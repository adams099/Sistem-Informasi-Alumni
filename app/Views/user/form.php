                            ...
                            <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input name="nim" type="text" required class="form-control" placeholder="NIM">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label class="control-label">IPK</label>
                                        <input name="ipk" type="text" required class="form-control" placeholder="IPK">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-md-6">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input name="pekerjaan" type="text" class="form-control" placeholder="Perkerjaan">
                                </div>
                                <div class="form-group col-md-6">
