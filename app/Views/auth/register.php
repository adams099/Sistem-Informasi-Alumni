                        ...
                        <div class="card z-index-0">
                            ...
                            <div class="card-body">
                                ...
                                <form action="<?= url_to('register') ?>" method="post" role="form text-left">
                                    ...
                                    <div class="mb-3">
                                        <input required aria-label="Email" type="email" class="form-control <?php if (session('errors.email')) : ?>is-invalid<?php endif ?>" name="email" aria-describedby="emailHelp" placeholder="<?= lang('Auth.email') ?>" value="<?= old('email') ?>">
                                    </div>
                                    <div class="mb-3">
                                        <input required type="password" name="password" class="form-control <?php if (session('errors.password')) : ?>is-invalid<?php endif ?>" placeholder="Password" aria-label="Password" aria-describedby="password-addon" placeholder="<?= lang('Auth.password') ?>" autocomplete="off">
                                    </div>
                                    <div class="mb-3">
                                        <input required type="password" name="pass_confirm" class="form-control <?php if (session('errors.pass_confirm')) : ?>is-invalid<?php endif ?>" placeholder="<?= lang('Auth.repeatPassword') ?>" autocomplete="off" aria-label="Password" aria-describedby="password-addon">
                                    </div>
                                    ...
                                    <p class="text-sm mt-3 mb-0">Already have an account? <a href="<?= url_to('login') ?>" class=" text-dark font-weight-bolder"><?= lang('Auth.signIn') ?></a></p>
                                </form>
                            </div>
                        </div>
                    </div>
