<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="<?= base_url('/'); ?>" target="_blank">
            ...
            <span class="ms-1 font-weight-bold">Sistem Informasi Alumni</span>
        </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            ?>
            <?php if (!$alumni || !$status) : ?>
                <?= $this->include('layout/component/bioData'); ?>

            <?php else : ?>
                <li class="nav-item">
                    <a class="nav-link <?= $currentRoute == 'dashboard' ? 'active' : ''; ?>" href="<?= base_url('/'); ?>">
                ...
                <?php if (in_groups('admin')) : ?>
                    <li class="nav-item">
                        <a class="nav-link <?= $currentRoute == 'List of User' ? 'active' : ''; ?>" href="<?= base_url('/admin/users'); ?>">
                            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            ...
                            <span class="nav-link-text ms-1">List of User</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link  <?= $currentRoute == 'Approval' ? 'active' : ''; ?>" href="<?= base_url('/admin/approval'); ?>">
                            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <li class="nav-item">
                    <a class="nav-link <?= $currentRoute == 'List of Alumni' ? 'active' : ''; ?>" href="<?= base_url('/alumni'); ?>">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        ...
                        <span class="nav-link-text ms-1">List of Alumni</span>
                    </a>
                </li>

                <?php if (!in_groups('guests')) : ?>
                    <li class="nav-item">
                        <a class="nav-link <?= $currentRoute == 'Feedback' ? 'active' : ''; ?>" href="/feedback">
                            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <div class="card card-background shadow-none card-background-mask-secondary" id="sidenavCard">
            ...
            <div class="card-body text-start p-3 w-100">
                ...
                <div class="docs-info">
                    ...
                    <p class="text-xs font-weight-bold">Check the user guide for details</p>
                    <a href="<?= in_groups('admin') ? site_url('guide-admin') : site_url('guide-alumni-student') ?>" target="_blank" class="btn btn-white btn-sm w-100 mb-0">Documentation</a>
                </div>
            </div>
        </div>
        <a class="btn bg-gradient-primary mt-3 w-100" href="<?= base_url('logout'); ?>">Logout</a>
    </div>
</aside>